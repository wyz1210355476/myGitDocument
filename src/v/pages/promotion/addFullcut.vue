<template>
	<active-common :step="step" @stepChange="stepChange" @rullChange="rullChange" @savePromtion="savePromtion" :btnLoading.sync="btnLoading" title="订单满减">
		...
		<!-- <template slot="saveBtn" slot-scope="{saveInfo}">
