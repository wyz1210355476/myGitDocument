//订单列表
export const list = {
	url: '/pmanager/foreign/order/get',
	method: "GET"
}
//添加订单
export const addOrder = {
	url: '/pmanager/foreign/Order/add',
	method: "POST"
}
//修改订单
export const modifyOrder = {
	url: '/pmanager/foreign/order/mod',
	method: "POST"
}
//获取订单详情
export const getOrderDetail = {
	url: '/pmanager/foreign/Order/detail',
	method: "GET"
}
// //删除订单
// export const delOrder = {
// 	url: '/pmanager/foreign/order/deleteOrder',
// 	method: "GET"
// }
//获取订单商品
export const getGoods = {
	url: '/pmanager/foreign/order/getGoods',
	method: "GET"
}
// //添加订单商品
// export const addGoods = {
// 	url: '/pmanager/foreign/order/addGoods',
// 	method: "POST"
// }
// //修改订单商品
// export const modifyGoods = {
// 	url: '/pmanager/foreign/order/modifyGoods',
// 	method: "POST"
// }
// //删除订单商品
// export const delGoods = {
// 	url: '/pmanager/foreign/order/delGoods',
// 	method: "GET"
// }
//获取订单备注
export const getRemark = {
	url: '/pmanager/foreign/order/getRemark',
	method: "GET"
}
//添加订单备注
export const addRemark = {
	url: '/pmanager/foreign/order/addRemark',
	method: "POST"
}
//获取订单日志
export const getLogs = {
	url: '/pmanager/foreign/order/getLogs',
	method: "GET"
}
//添加订单日志
export const addLogs = {
	url: '/pmanager/foreign/order/addLogs',
	method: "POST"
}
//获取订单留言
export const getMessage = {
	url: '/pmanager/foreign/order/getMessage',
	method: "GET"
}
//添加订单留言
export const addMessage = {
	url: '/pmanager/foreign/order/addMessage',
	method: "POST"
}
//获取订单历史
export const getHistory = {
	url: '/pmanager/foreign/order/getHistory',
	method: "GET"
}
//导出订单
export const exportOrder = {
	url: '/pmanager/foreign/order/export',
	method: "GET"
}
//获取配送方式
...
export const getShipCost = {
	url: '/pmanager/logistics/logisticsPriceExt',
	method: "GET"
}
//获取支付方式
...
export const getDeliveryList = {
	url: '/pmanager/foreign/shipmentreturns/sendGoodsList',
	method: "GET"
}
//发货单详情
export const getDeliveryDetail = {
	url: '/pmanager/foreign/shipmentreturns/sendGoodsInfo',
	method: "GET"
}
//添加发货单
export const addDeliveryOrder = {
	url: '/pmanager/foreign/shipmentreturns/sendGoods',
	method: "POST"
}
//退货单列表
export const getReturnList = {
	url: '/pmanager/foreign/shipmentreturns/returnGoodsList',
	method: "GET"
}
//退货单详情
export const getReturnDetail = {
	url: '/pmanager/foreign/shipmentreturns/returnGoodsInfo',
	method: "GET"
}
//添加退货单
export const addReturnOrder = {
	url: '/pmanager/foreign/shipmentreturns/returnGoods',
	method: "POST"
}
//订单商品列表
...
export const getMemberPrice = {
	url: '/pmanager/foreign/order/memberPrice',
	method: "GET"
}
//获取促销价格
...
export const calculatePrice = {
	url: '/pmanager/foreign/order/calculatePrice',
	method: "GET"
}
//获取订单满减金额
...
export const getLoginInfo = {
	url: '/pmanager/foreign/order/getLoginInfo',
	method: "GET"
}
//获取已退货数量
...
export const getBatchPrice = {
	url: '/pmanager/foreign/order/batchPrice',
	method: "GET"
}
//获取订单消费的返利金额
